    ...
    >
        <div class="sidenav-header">
            ...
            <a
                ...
                href="https://demos.creative-tim.com/marketplace/soft-ui-dashboard-pro/pages/dashboards/default.html"
                target="_blank"
            >
                <span class="ms-1 font-weight-bold"
                    ><h4>Shop Dashboard</h4></span
                >
            </a>
        </div>
        ...
        >
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="/shop/dashboad">
                        <div
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="authExamples">
                        <ul class="nav ms-4 ps-3">
                            <li class="nav-item">
                                <a class="nav-link" href="/shop/settings">
        ...
        <div class="sidenav-footer mx-3 mt-3 pt-3">
            ...
            >
                <div
                    ...
                    style="
                        background-image: url('user-assets/img/curved-images/white-curved.jpg');
                    "
                ></div>
                <div class="card-body text-start p-3 w-100">
                    ...
                    <div class="docs-info">
                        ...
                        <p class="text-xs font-weight-bold">Contact Us</p>
                        <a
                            href="/"
                            target="_blank"
