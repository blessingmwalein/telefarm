<template>
    <shop-layout :title="'Create New Product'">
        <div class="container-fluid">
            <div
                class="page-header min-height-300 border-radius-xl mt-4"
                style="
                    background-image: url('/user-assets/img/curved-images/curved0.jpg');
            ...
            <div class="row">
                <div class="col-12">
                    <div class="multisteps-form">
                        <div class="row">
                            <div
                                class="col-12 col-lg-8 mx-auto mt-4 mb-sm-5 mb-3"
                            >
                                ...
                                <form class="multisteps-form__form mb-8">
                                        ...
                                        <div class="multisteps-form__content">
                                            <div class="row mt-3">
                                                <div class="col-12">
                                                    ...
                                                    >
                                                    <div
                                                        action="https://demos.creative-tim.com/file-upload"
                                            ...
                                            <div class="button-row d-flex mt-4">
                                                <button
                                                    class="btn bg-gradient-secondary mb-0 js-btn-prev"
                                                    type="button"
                                                    title="Prev"
                                                >
                                                    Prev
                                    ...
                                    >
                                        ...
                                        <div class="multisteps-form__content">
                                            ...
                                            <div class="row">
                                                <div
                                                    class="button-row d-flex mt-4 col-12"
                                                >
                                                    <button
                                                        class="btn bg-gradient-secondary mb-0 js-btn-prev"
                                                        type="button"
                                    ...
                                    >
                                        ...
                                        <div
                                            class="multisteps-form__content mt-3"
                                        >
                                            <div class="row">
                                                <div class="col-3">
                                                    <label>Price</label>
