                ...
                <div class="row">
                    ...
                    <div class="col-md-3 sidebar">
                        ...
                        <div class="sidebar-module-container">
                            <div class="sidebar-filter">
                                ...
                                <div
                                    class="sidebar-widget product-tag wow fadeInUp outer-top-vs animated"
                                    style="
                                        visibility: visible;
                                        animation-name: fadeInUp;
                                    "
                                >
                                    ...
                                    <div
                                        class="sidebar-widget-body outer-top-xs"
                                    >
                                        <div class="tag-list">
                                            <a
                    ...
                    <div class="col-md-9 rht-col">
                        <div class="clearfix filters-container m-t-10">
                            <div class="row">
                                <div
                                    class="col col-sm-6 col-md-3 col-lg-3 col-xs-6"
                                >
                                ...
                                <!-- /.col -->
                                <div
                                    class="col col-sm-12 col-md-5 col-lg-5 hidden-sm"
                                >
                                    <div
                                        class="col col-sm-6 col-md-12 col-lg-7 no-padding"
                                    >
                                        <!-- /.lbl-cnt -->
                                    </div>
                                    <!-- /.col -->
                                    <div
                                        class="col col-sm-6 col-md-5 col-lg-5 no-padding hidden-sm hidden-md"
                                    >
                                        <div class="lbl-cnt">
                      ...
                      <div class="fld inline">
                        ...
                        >
                          ...
                          <ul role="menu" class="dropdown-menu">
                            ...
                            <li role="presentation"><a href="#">10</a></li>
                                ...
                                <!-- /.col -->
                                <div
                                    class="col col-sm-6 col-md-4 col-xs-6 col-lg-4 text-right"
                                >
                        ...
                        <div class="search-result-container">
                            <div class="card text-center alert alert-danger">
                                <h2>Opps No items found search again !</h2>
                            </div>
                        </div>
...
export default {
    props: ["query", "categories", "shops", "colors", "products"],
    components: {
        AppLayout,
        FooterNav,
        ProductCard,
